...
function convertBacktickText($text) {
...
if ($command == '/start') {
    ...
    $bot->sendMessage(
        $chatId,
        "Welcome to the DNS Lookup Bot! You can use the following commands:\n
    ...
    $bot->sendMessage($chatId, convertBacktickText($innerHtml), ['parse_mode' => 'HTML']);
